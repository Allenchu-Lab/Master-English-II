...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (typeof analysis.summary !== "string" || typeof analysis.translation !== "string" || !Array.isArray(analysis.structure) || !Array.isArray(analysis.vocabulary) || typeof analysis.examTip !== "string") {
